  ...
  return (
    <footer className="bg-white border-t border-gray-100 pt-16">
      ...
      <div className="max-w-[1320px] mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 pb-12">
        {/* Col 1: Logo + About */}
        <div>
          <a href="/" className="block w-[160px] mb-6">
            <img
          ...
          <div className="flex flex-col gap-3">
             <div className="flex items-center gap-2 text-sm text-[#444] font-bold">
               <div className="w-8 h-8 rounded-full bg-[#fff0f3] flex items-center justify-center text-[#FF4D6D]">
             ...
             <div className="flex items-center gap-2 text-sm text-[#666]">
               ...
               শনি–বৃহস্পতি: ১০টা – ৮টা
             </div>
          </div>
          <div className="flex gap-3 mt-6">
            <a href="https://facebook.com/kcbazar22" className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-[#555] transition-all hover:bg-[#FF4D6D] hover:text-white" aria-label="Facebook" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.instagram.com/kcbazarltd/" className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-[#555] transition-all hover:bg-[#FF4D6D] hover:text-white" aria-label="Instagram" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.youtube.com/@kcbazar" className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-[#555] transition-all hover:bg-[#FF4D6D] hover:text-white" aria-label="YouTube" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.tiktok.com/@kcbazar" className="w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center text-[#555] transition-all hover:bg-[#FF4D6D] hover:text-white" aria-label="TikTok" target="_blank" rel="noreferrer">
        ...
        {/* Col 2: Categories */}
        <div>
          <h4 className="text-base font-bold text-[#111] mb-8 pb-1 border-b-2 border-[#FF4D6D] w-fit">Categories</h4>
          <div className="flex flex-col gap-3">
            {categories.map((item) => (
              <a key={item.label} href={item.href} className="text-sm text-[#666] hover:text-[#FF4D6D] transition-colors duration-200">
                {item.label}
              </a>
            ))}
          </div>
        ...
        {/* Col 3: Useful Links */}
        <div>
          <h4 className="text-base font-bold text-[#111] mb-8 pb-1 border-b-2 border-[#FF4D6D] w-fit">Useful Links</h4>
          <div className="flex flex-col gap-3">
        ...
        <div>
          <h4 className="text-base font-bold text-[#111] mb-8 pb-1 border-b-2 border-[#FF4D6D] w-fit">Important Pages</h4>
          <div className="flex flex-col gap-3">
