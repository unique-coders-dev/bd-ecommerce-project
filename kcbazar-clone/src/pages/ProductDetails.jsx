...
const ProductDetails = () => {
  ...
  // Product data based on the provided reference (Dabo Primer)
  const product = {
    id: id || 21656,
  ...
  return (
    <div className="bg-[#f2f2f2] min-h-screen font-sans w-full flex flex-col">
      {/* Breadcrumb Section - Non-sticky as requested */}
      <div className="w-full bg-white border-b border-[#e1e1e1] flex-shrink-0 relative z-[40]">
        <div className="max-w-[1320px] mx-auto px-4 py-3 flex items-center text-[13px] text-[#777] w-full">
          <Link to="/" className="hover:text-[#FF4D6D] transition-colors">Home</Link>
          <span className="mx-2.5 text-gray-300">/</span>
          <Link to="/shop" className="hover:text-[#FF4D6D] transition-colors">Shop</Link>
          <span className="mx-2.5 text-gray-300">/</span>
      ...
      <div className="w-full max-w-[1320px] mx-auto px-4 flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div className="flex flex-col-reverse md:flex-row gap-4 h-auto md:h-[500px]">
              ...
              <div className="flex flex-row md:flex-col gap-2.5 w-full md:w-[80px] h-fit md:h-full flex-shrink-0 relative">
                {/* Prev Arrow (Top on Desktop, Left on Mobile) */}
                <button 
                ...
                {/* Next Arrow (Bottom on Desktop, Right on Mobile) */}
                <button 
            ...
            <div className="flex flex-col">
              <div className="flex justify-between items-start mb-4">
                <div className="flex flex-col gap-2">
                  <Link to="/brand/dabo" className="text-[11px] font-black uppercase text-[#FF4D6D] tracking-[2px] hover:underline underline-offset-4">{product.brand}</Link>
              ...
              <div className="pt-6 border-t border-gray-100 space-y-3.5 text-[13px]">
                ...
                <div className="flex gap-2"><span className="font-black text-[#111] uppercase w-[90px] shrink-0 text-[11px] tracking-widest">Category:</span><Link to="/shop" className="text-[#FF4D6D] hover:underline underline-offset-4 transition-all font-black">{product.category}</Link></div>
        ...
        <section className="mt-16 mb-20">
          <div className="flex items-center justify-between mb-8 group">
            ...
            <Link to="/shop" className="text-[11px] font-black uppercase text-[#FF4D6D] tracking-widest hover:translate-x-2 transition-transform flex items-center gap-2">Explore Shop <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg></Link>
          </div>
