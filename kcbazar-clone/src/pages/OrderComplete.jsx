      ...
      <div className="max-w-[1320px] mx-auto px-4">
        ...
        <div className="bg-[#FF4D6D] text-white py-8 lg:py-12 rounded-xl mb-10 shadow-lg shadow-[#FF4D6D]/10">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-10 text-sm md:text-xl font-black uppercase tracking-[2px] lg:tracking-[4px]">
             ...
             <Link to="/checkout" className="opacity-40 hover:opacity-100 transition-opacity">Checkout</Link>
             <span className="hidden md:inline opacity-40">→</span>
        ...
        <div className="max-w-[900px] mx-auto space-y-8">
            ...
            <div className="bg-[#E6F9F3] border border-[#BFF0E1] text-[#0D9488] p-6 rounded-xl text-center font-black text-lg py-10 flex flex-col items-center gap-4 shadow-sm">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-sm"><svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path d="M5 13l4 4L19 7"/></svg></div>
                ...
                <div className="p-8">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {[
                                { name: "Missha Soft Finish Sun Milk SPF50+ PA+++ 70 ml", qty: 1, price: "1,200" },
                            ].map((item, i) => (
                                <tr key={i}>
                                    <td className="py-6 pr-4">
                                        <Link to="/product/1" className="text-sm font-bold text-gray-600 hover:text-[#FF4D6D] transition-colors">{item.name}</Link>
            ...
            <div className="text-center pt-8">
                <Link to="/" className="inline-block py-4 px-12 bg-[#111] text-white font-black uppercase text-sm tracking-[3px] rounded-xl hover:bg-black transition-all shadow-xl shadow-black/10 active:scale-95">Continue Shopping</Link>
            </div>
