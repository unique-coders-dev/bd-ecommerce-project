              ...
              {orders.map((order, i) => (
                <tr key={i} className="hover:bg-gray-50/20 transition-all">
                  ...
                  <td className="px-8 py-6 text-right">
                    <button className="text-primary font-black text-[11px] uppercase tracking-widest border-2 border-primary px-4 py-2 rounded-lg hover:bg-primary hover:text-white transition-all cursor-pointer">Manage</button>
                  </td>
                </tr>
              ))}
            </tbody>
