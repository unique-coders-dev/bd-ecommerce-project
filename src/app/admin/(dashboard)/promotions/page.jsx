  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <button className="px-6 py-3 bg-primary text-white font-black uppercase text-[11px] tracking-widest rounded-xl hover:bg-primary-dark transition-all shadow-xl shadow-primary/30 cursor-pointer">Create Coupon</button>
      </div>
                ...
                <tr key={c.id} className="hover:bg-gray-50/20 transition-all group">
                  <td className="px-8 py-6">
                    <div className="flex flex-col">
                      <span className="text-sm font-black text-primary uppercase tracking-[2px]">{c.code}</span>
                  ...
                  <td className="px-8 py-6 text-right">
                    <button className="text-primary font-black text-[11px] uppercase tracking-widest border-2 border-primary px-4 py-2 rounded-lg hover:bg-primary hover:text-white transition-all cursor-pointer">Edit Coupon</button>
                  </td>
                </tr>
              ))}
            </tbody>
