    ...
    <section className="py-4 bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 max-w-[1320px] mx-auto px-4">
        ...
        <div className="relative rounded-xl overflow-hidden h-[220px] sm:h-[300px] md:h-[420px] bg-[#eee]">
          ...
          {/* Arrows */}
          <button
            className="absolute top-1/2 -translate-y-1/2 left-3 w-10 h-10 bg-white/70 hover:bg-white rounded-full z-10 flex items-center justify-center text-xl transition-all shadow-md cursor-pointer"
          ...
          <button
            className="absolute top-1/2 -translate-y-1/2 right-3 w-10 h-10 bg-white/70 hover:bg-white rounded-full z-10 flex items-center justify-center text-xl transition-all shadow-md cursor-pointer"
